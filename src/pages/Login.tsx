...
const Login = () => {
  ...
  return (
    <div className="login">
      <Row align="middle">
        <Col span={12}>
          <Typography.Title level={2} className="text-center">Outlay - Login</Typography.Title>
          <Form
            name="register"
            labelCol={{span: 8}}
            wrapperCol={{span: 24}}
          ...
          >
            ...
            <Form.Item>
              <div className="d-flex justify-content-between">
                <Button type="text" href="/register">Not registered. Click here to register</Button>
